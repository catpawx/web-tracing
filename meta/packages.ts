export const packages: any[] = [
  ...
  // },
  {
    ...
    exampleName: "vanilla",
    exampleGitHubPath: "https://github.com/catpawx/web-tracing-examples-js",
  },
  {
    name: "vue2",
    display: "Vue2",
    ...
    exampleName: "vue2",
    exampleGitHubPath: "https://github.com/catpawx/web-tracing-examples-vue2",
  },
  {
    name: "vue3",
    display: "Vue3",
    ...
    exampleName: "vue3",
    exampleGitHubPath: "https://github.com/catpawx/web-tracing-examples-vue3",
  },
  // {
  //   name: 'utils',
  //   display: 'Utils',
  //   description: '@catpawx/utils',
  //   keywords: [
  //     '埋点',
  //     '性能',
  //     '异常',
