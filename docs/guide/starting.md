...
::: tip
以下只展示了【 js、vue2、vue3 】的安装方式，因为目前作者只创建了这些 demo 项目；因为此 sdk 是纯 js 编写，如果您的项目支持浏览器对象那么理论上都会支持
:::
...
```
// 核心实现包 - js
pnpm install @catpawx/web-tracing-core

// vue2版本
pnpm install @catpawx/web-tracing-vue2

// vue3版本
pnpm install @catpawx/web-tracing-vue3
```
...
<html lang="en">
  ...
  <script src="https://cdn.jsdelivr.net/npm/@catpawx/web-tracing-core"></script>
  <script>
    webtracing.init({
      appName: "cxh",
      debug: true,
