...
[完整示例项目 https://github.com/catpawx/web-tracing-examples-js](https://github.com/catpawx/web-tracing-examples-js)
...
[完整示例项目 https://github.com/catpawx/web-tracing-examples-vue2](https://github.com/catpawx/web-tracing-examples-vue2)
...
import WebTracing from "@catpawx/web-tracing-vue2";
...
[完整示例项目 https://github.com/catpawx/web-tracing-examples-vue3](https://github.com/catpawx/web-tracing-examples-vue3)
...
import WebTracing from "@catpawx/web-tracing-vue3";
    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="资源错误事件" name="second">
        <div class="mb resource">
          ...
          <img
            v-if="showImgFalse"
            src="https://cdn.jsdelivr.net/gh/jswangtao/imgsbed/posts/20240802175924.webp"
          />
        </div>
        <div class="mb resource">
...
import axios from 'axios'
import { traceError, unzipRecordscreen } from '@catpawx/web-tracing-vue3'
