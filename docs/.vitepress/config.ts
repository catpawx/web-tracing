...
export default defineConfig({
  ...
  themeConfig: {
    logo: "https://cdn.jsdelivr.net/gh/jswangtao/imgsbed/posts/20240802173920.svg",
    ...
    editLink: {
      pattern: "https://github.com/catpawx/web-tracing/blob/main/docs/:path",
      text: "Suggest changes to this page",
    },

    socialLinks: [
      { icon: "github", link: "https://github.com/catpawx/web-tracing" },
    ],
  ...
  head: [
    [
      ...
      {
        rel: "icon",
        href: "https://cdn.jsdelivr.net/gh/jswangtao/imgsbed/posts/20240802173920.svg",
      },
    ],
  ],
});
