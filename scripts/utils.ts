...
export async function updatePackageJSON() {
  ...
  for (const {
    ...
    packageJSON.author = author || "catpawx <https://github.com/catpawx>";
    packageJSON.bugs = {
      url: "https://github.com/catpawx/web-tracing/issues",
    };
    packageJSON.homepage = "https://github.com/catpawx/web-tracing#readme";
    packageJSON.repository = {
      type: "git",
      url: "git+https://github.com/catpawx/web-tracing.git",
